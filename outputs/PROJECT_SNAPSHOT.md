...
- Exportacao PDF refinada para computador: captura realizada a partir de um conteiner temporario dedicado, sem ocultar o app inteiro, para evitar falha automatica na geracao e reduzir deslocamento lateral.
